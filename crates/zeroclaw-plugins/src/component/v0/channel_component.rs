...
impl Channel for ComponentChannel {
    ...
    async fn send(&self, message: &SendMessage) -> anyhow::Result<()> {
        ...
        call_plugin!(self, "send", move |store, bindings: &mut ChannelPlugin| {
            bindings
                .zeroclaw_plugin_channel()
    ...
    fn self_handle(&self) -> Option<String> {
        ...
        let state = Arc::clone(&self.state);
        // Blocking call acceptable here — trait is sync.
    ...
    fn supports_multi_message_streaming(&self) -> bool {
        ...
        bindings
            .zeroclaw_plugin_channel()
            .call_supports_multi_message_streaming(store)
            .unwrap_or(false)
    }
    ...
    fn supports_free_form_ask(&self) -> bool {
        ...
        bindings
            .zeroclaw_plugin_channel()
            .call_supports_free_form_ask(store)
            .unwrap_or(true)
    }
}
